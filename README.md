...
| Are you ready to play? (NO) | When a player chooses not to play and writes "no" in the terminal, a player should receive a message stating "You are welcome back another time. Have a nice day!" | Type "no" into the terminal | "You are welcome back another time. Have a nice day!" message appears on the screen. | Pass
